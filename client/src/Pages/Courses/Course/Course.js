...
const Course = ({course}) => {
    const{courseDuration,courseName,alreadyEnrolled,price,instructorName,instructor,courseDetail,_id,picture}=course;
    console.log(course)
    return (
        <div>
            <div className="card w-96 bg-base-100 shadow-xl">
        <figure><img src={picture} alt="img-1" border="0"/></figure>
